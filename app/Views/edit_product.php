...
<head>
  ...
  <title>Edit Product | Spotify Inventory</title>
  ...
  <style>
    ...
    .spotify-form-card::before {
      ...
      right: 0;
      height: 6px;
      background: linear-gradient(90deg, #1ed760, var(--spotify-green), #1aa34a);
      opacity: 0.9;
    }
...
<body>
    ...
    <div class="form-container">
      <div class="spotify-form-card">
        ...
        <div class="form-header">
          <h2 class="form-title">Edit Product <span class="product-info-badge">ID: <?= esc($product['id']) ?></span></h2>
          <p class="form-subtitle">Update the details for <?= esc($product['product_name']) ?></p>
        </div>
          ...
          <form action="<?= base_url('products/update/'.$product['id']) ?>" method="post" id="editProductForm">
            ...
            <div class="form-group">
              ...
              <textarea name="description" 
                        ...
                        rows="4"
                        maxlength="500"><?= esc($product['description']) ?></textarea>
              <div class="char-count" id="charCount"><?= strlen(esc($product['description'])) ?>/500</div>
            </div>
            ...
            <div class="form-actions">
              ...
              <button type="submit" class="btn-spotify" id="submitBtn">
                <i class="bi bi-arrow-repeat"></i>Update Product
              </button>
            </div>
          </form>
        </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (description && charCount) {
        description.addEventListener('input', function() {
          ...
          if (length > 450) {
            ...
            charCount.style.color = 'var(--spotify-text-gray)';
          }
        });
      }
        ...
        form.addEventListener('submit', function(e) {
          ...
          setTimeout(() => {
            if (!form.checkValidity()) {
              ...
              submitBtn.innerHTML = '<i class="bi bi-arrow-repeat"></i> Update Product';
            }
          }, 2000);
        });
      }
      ...
      // Detect changes and prompt before leaving
      let isDirty = false;
      ...
      const cancelBtn = document.querySelector('.btn-spotify-outline');
      if (cancelBtn) {
